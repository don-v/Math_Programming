...
scatter x=x y=g/name='cosx' legendlabel='y = sin(x)';
scatter x=x y=h/name='cosx1' legendlabel='y = 1/x';
scatter x=x y=f/name='cosax' legendlabel='y = (sin(x))/x';
...
/*yaxis max=1 min=-1;*/
/*xaxis min=-6.3 max = 6.3 values = (-6.28 -4.71 -3.14 -1.57 0 1.57 3.14 4.71 6.28) valuesformat=pi2u_neg2pi_2pi_f.;*/
title 'CalcE_Q1: f(x) = (sin(x))/x paneled';
run;
